...
//Teste com o Método GET ALL realizando o Assert / Validacao nos Registros do Array do Response
public class Test03_GET_All  {
	
	// Dados dos Registros da API para o Assert / Validação do Response	
